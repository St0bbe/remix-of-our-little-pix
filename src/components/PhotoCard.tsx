...
export const PhotoCard = ({ photo, onDelete, onView }: PhotoCardProps) => {
  ...
  return (
    <div
      className="group relative bg-card rounded-xl overflow-hidden shadow-card hover:shadow-hover transition-all duration-300 animate-scale-in"
      ...
      >
        <div className="absolute bottom-0 left-0 right-0 p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-primary-foreground font-medium">{photo.childName}</p>
